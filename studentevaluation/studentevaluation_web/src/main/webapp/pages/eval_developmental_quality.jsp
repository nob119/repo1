            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        ...
                        <input type="hidden" name="studentId" value="<%=studentId%>">
                            <div class="box box-primary">
                                ...
                                <div class="box-header with-border">
                                    <h3 class="box-title">创新创业</h3>
                                </div>
                                <div class="box-body">
                                    <input class="form-control" name="civilization" id="" type="text" >
                                    <br>
                                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">实践服务与公益活动</h3>
                        </div>
                        <div class="box-body">
                            <input class="form-control" name="civilization" id="" type="text" >
                            <br>
